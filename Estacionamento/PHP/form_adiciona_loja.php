...
<html  lang="pt-br">
  <head>
      ...
      <link rel="stylesheet" href="..\CSS\estilo_adicionar_loja.css">
  ...
  <body class="section" style="background: #45d6b2; font-family: 'Trirong', serif; ">
    ...
    <div class="container mt-4"  style=" font-family: 'Trirong', serif; background: rgba(215, 246, 236, 0.87);border-radius: 30px 30px; ">
      ...
      <div class="login">
        <h1 style=" font-family: 'Trirong', serif;"> <b>Cadastrar Loja</b> <img src="https://img.icons8.com/plasticine/60/000000/online-shop.png"/></h1>

        <form class="form" method="POST" action="adicionar_loja.php">
          &nbsp;  &nbsp;  &nbsp; &nbsp;  
          <img src="https://img.icons8.com/color/40/000000/shop.png"/>
            <input style="border-radius: 15px;" type="text" name="Nomeloja" placeholder="Nome da Loja" required/>
          
            &nbsp;
          <img src="https://img.icons8.com/color/40/000000/car--v2.png"/>
          <input style="border-radius: 15px" type="text" name="CEP" placeholder="CEP: XXXXX-XXX" required/>
          
          <br>
          &nbsp;  &nbsp;  &nbsp; &nbsp;  
          <img src="https://img.icons8.com/color/40/000000/car--v2.png"/>
          <input style="border-radius: 15px" type="text" name="Email" placeholder="E-mail" required/>
          ...
          <input style="border-radius: 15px" type="text" name="TelefoneLoja" placeholder="Telefone da Loja" required/>
